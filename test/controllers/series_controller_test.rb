...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference("Serie.count") do
      post series_url, params: { series: { atual: @series.atual, episodios: @series.episodios, nome: @series.nome, nota: @series.nota } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { atual: @series.atual, episodios: @series.episodios, nome: @series.nome, nota: @series.nota } }
